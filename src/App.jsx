...
function App() {
  // const modal = useRef();
  // switching from imperative to declarative way of managing the modal
  ...
  // saves the argument function internally, so that its value won't change
  // avoids triggering infinite loop with useEffect
